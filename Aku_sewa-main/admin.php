...
<body>
    ...
    <div class="hal1" id="home">
        <div class="text">
            ...
            <h5>Selamat datang di Juragan Kos <br>
             solusi terbaik untuk persewaan Kamar Kos Anda! <br>
            Kami menyediakan berbagai macam Kamar Kos yang berkualitas tinggi,<br>
            mulai dari Kamar Kos tipe kecil, Tipe besar, tipe menengah,hingga on budget dll.</h5>
        </div>
