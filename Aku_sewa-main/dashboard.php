...
<body>
    ...
    <div class="hal1" id="home">
        <div class="text">
            <h1>Welcome to<br>Juragan Kos</h1>
            <h5>Website persewaan Kos-Kosan adalah platform informatif <br>
             yang dirancang untuk memudahkan mahasiswa untuk mencari tempat tinggal . </h5>
        </div>
        <img class="mic" src="asset/Kamar3.jpg" alt="">
            ...
            <div class="row baris">
                <div class="col-4 kolom">
                    <div class="kot shadow">
                        ...
                        <p class="text-center mt-4 p-3">Kami adalah penyedia layanan persewaan Kos-Kosan terpercaya yang berkomitmen untuk memenuhi kebutuhan Anda kapan saja</p>                   
                    </div>
                </div>
                <div class="col-4 kolom">
                    <div class="kot shadow">
                        ...
                        <p class="text-center mt-4 p-3">Kami menjamin kepuasan Anda dengan layanan persewaan Kos-Kosan terbaik. Kepuasan pelanggan adalah prioritas utama kami.</p>                   
                    </div>
                </div>
                <div class="col-4 kolom">
                    <div class="kot shadow">
                        ...
                        <p class="text-center mt-4 p-3">Sewa Kos-Kosan pilihan Anda sekarang dan .</p>                   
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card-body bdy" style="height: 18em;">
        <h5 class="card-title" style="margin-top: 5em;">Juragan Kos</h5>
            <p class="card-text">Misi kami adalah mempermudah akses mahasiswa terhadap Kos-Kosan yang diperlukan tanpa harus membeli rumah. Dengan sistem sewa yang fleksibel, Anda dapat menghemat biaya dan ruang penyimpanan,</p>
                ...
                <div class="card shadow" style="width: 18rem;">
                    ...
                    <div class="card-body" style="background-color: #F5F5F5;">
                        ...
                        <div class="harga mt-4 d-flex">
                            ...
                            <a href="detailproduk.php?id=<?= $data['id_produk'] ?>"><button class="booking">Booking</button></a>
                        </div>
                    </div>
                </div>
            </div>
